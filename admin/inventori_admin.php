...
?>
    ...
    $sql = mysql_query("SELECT * FROM kategori ORDER BY nama ASC");
    ...
    ?>
                    ...
                    <input class="form-control" type="number" name="stok" placeholder="Stok" maxlength="4" required> 
                    <br>
                     <input class="form-control" type="number" name="harga" placeholder="Harga" maxlength="11" required>
                </div>
